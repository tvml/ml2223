...
<xsl:template match="/atom:feed">
	...
	<link rel="stylesheet" type="text/css" href="http://localhost:4000/ml2223/assets/css/styles_feeling_responsive.css" />
	<script src="http://localhost:4000/ml2223/assets/js/modernizr.min.js"></script>
  ...
  <noscript>
	...
	<meta property="og:url" content="http://localhost:4000/ml2223//assets/xslt/atom.xslt" />
	...
	<link type="text/plain" rel="author" href="http://localhost:4000/ml2223/humans.txt" />
...
<div id="navigation" class="sticky" >
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/ml2223" class="icon-tree"> Machine learning</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a href="http://localhost:4000/ml2223/">Start</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/info/">Informazioni</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/programma/">programma</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/lucidi/">lucidi</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/note/">note</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/codici/">codici</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/dataset/">dataset</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/comunicazioni/">Comunicazioni</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/lezioni/">Lezioni</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/progetti/">Progetti</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/store/">Store</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://localhost:4000/ml2223/biblio/">Bibliografia</a></li>
              <li class="divider"></li>
		...
		<div class="row">
			<div class="small-12 columns">
				...
				<p style="text-align:center;">
					<img src="http://localhost:4000/ml2223/assets/img/" alt="Machine learning – Università di Roma Tor Vergata">
				</p>
				</a>
...
<script src="http://localhost:4000/ml2223/assets/js/javascript.min.js"></script>
